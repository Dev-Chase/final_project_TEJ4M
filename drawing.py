...
# Drawing
def draw_results(frame, face_locations, face_people, cv_scaler=CV_SCALER, default_colour=colours["blue"]):
    # Display the results
    for (top, right, bottom, left), person in zip(face_locations, face_people):
        ...
        cv2.putText(frame, name, (left + 6, top - 6), font, 1.0, colours["white"], 1)
